...
import com.my_universe.mainAdapter.MyAdapterRetrofit77
import com.my_universe.databinding.ActivityNetworkDataTestBinding
...
class NetworkDataTestActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 1
        val networkService = (applicationContext as com.my_universe.MyApplication).networkService
